    ...
    <div>
      <div className="w-full flex justify-between fixed p-[1.25rem] border-[#fff] border-1">
        ...
        <div className="flex flex-row gap-[0.938rem]">
          <button className="w-[5.625rem] h-[2.rem] text-[#fff] bg-transparent border-[0.125rem] border-[#fff] rounded-[1.25rem] cursor-pointer hover:bg-[#fff]text-[#000]">Login</button>
        </div>
      </div>
    </div>
  )
